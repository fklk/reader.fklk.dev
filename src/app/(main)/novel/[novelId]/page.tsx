...
import AddNovelToListButton from "@/components/button/novel/add-to-list";
...
export default async function NovelPage(props: NovelPageProps) {
    ...
    return (
        <div className="flex h-full gap-12 mt-4 justify-between relative">
            <div
                className="absolute h-[70%] filter grayscale hover:grayscale-0 rounded-md overflow-hidden aspect-[9/16] right-0"
                style={{
